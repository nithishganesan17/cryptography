...
int main() {
    char ciphertext[] = "Wklv lv d whvw fkdqjh lqirupdwlrq frpelqhg wr dq rughu dqg wkh ghflskhu wkhuhv d lpdjhu dqg d xqltxh pdwfk dqg d qhz pdwfk"; // Example ciphertext
